...
$databases = array (
  ...
  array (
    ...
    array (
      'database' => 'abrstagedb',
      'username' => 'abrstageuser',
      'password' => 'v3DCniJvW9jcVE',
      'host' => 'abrstagedb.ca04hipzstem.us-west-2.rds.amazonaws.com',
      'port' => '3306',
      'driver' => 'mysql',
      'prefix' => '',
    ),
 ...
 *
 */
$drupal_hash_salt = 'yDSdGgyoScoNL7nj_D0QwYvQ3bFw5GPaDvasb9tJKpI';
 ...
 *
 * The S3 File System (s3fs) module provides an additional file system to your
 * drupal site, which stores files in Amazon's Simple Storage Service (S3).
 *
 * @see https://www.drupal.org/project/s3fs
 */
$conf['awssdk2_use_instance_profile'] = TRUE;
$conf['awssdk2_default_cache_config'] = '/tmp/aws-credentials';

$conf['s3fs_use_cname'] = TRUE ;
$conf['s3fs_domain'] = 'stage-static.americasbestracing.net';
$conf['s3fs_bucket'] = 'abr-stage-static';
